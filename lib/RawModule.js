...
class RawModule extends Module {
	...
	build(options, compilation, resolver, fs, callback) {
		this.buildMeta = {
			exportsType:
				/** @type {import("./Module").KnownBuildMeta['exportsType']} */ (
					"default"
				)
		};
		this.buildInfo = {
	 ...
	 */
	codeGeneration({ concatenationScope, runtimeTemplate }) {
		...
		if (this.useSourceMap || this.useSimpleSourceMap) {
			...
			if (concatenationScope) {
				...
				} ${ConcatenationScope.NAMESPACE_OBJECT_EXPORT} = ${this.sourceStr};`;
				concatenationScope.registerNamespaceExport(
					ConcatenationScope.NAMESPACE_OBJECT_EXPORT
				);
				sources.set("javascript", new RawSource(sourceStr));
			} else {
