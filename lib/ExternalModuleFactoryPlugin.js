...
/** @typedef {import("../declarations/WebpackOptions").ExternalsTypeLiteral} ExternalsTypeLiteral */
/** @typedef {import("../declarations/WebpackOptions").ExternalsType} ExternalsType */
/** @typedef {import("../declarations/WebpackOptions").Externals} Externals */
/** @typedef {import("../declarations/WebpackOptions").ExternalsCategory} ExternalsCategory */
/** @typedef {import("./Compilation").DepConstructor} DepConstructor */
/** @typedef {import("./ExternalModule").DependencyMeta} DependencyMeta */
/** @typedef {import("./Module")} Module */
/** @typedef {import("./dependencies/ModuleDependency")} ModuleDependency */
/** @typedef {import("./NormalModuleFactory")} NormalModuleFactory */
/** @typedef {import("./NormalModuleFactory").ResolveData["dependencyType"]} DependencyType */
...
class ExternalModuleFactoryPlugin {
	/**
	 * @param {ExternalsType | undefined} type default external type
				...
				const handleExternal = (value, type, callback) => {
					...
					callback(
						...
						new ExternalModule(
							...
							(
								type ||
									this.resolveGlobalType(globalType, dependency, dependencyType)
							),
							dependency.request,
							dependencyMeta
						)
	...
	/**
	 * @param {ExternalsType} externalType default external type
	 * @param {ModuleDependency} dependency module dependency
	 * @param {DependencyType} dependencyType dependency category
	 * @returns {ExternalsTypeLiteral} literal external type
	 */
	resolveGlobalType(externalType, dependency, dependencyType) {
		if (typeof externalType === "string") {
			return externalType;
		}

		const externalCategory = dependency.getExternalCategory();
		const resolved = externalType[externalCategory] || externalType.fallback;

		if (resolved === undefined) {
			throw new Error(
				`Externals category '${externalCategory}' is not specified in externalsType map. Please provide a valid externals type for '${externalCategory}' or add a 'fallback' category.`
			);
		}
